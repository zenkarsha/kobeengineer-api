...
{{-- Page basic settings --}}
@section('page-title', \Lang::get('page-title.dashboard-setting-domain-blacklist'))
...
@section('content')
  @include('partial.dashboard.form.setting-domain-blacklist-create-form')
...
@section('foot')
  @include('partial.dashboard.script.setting-domain-blacklist')
@endsection
