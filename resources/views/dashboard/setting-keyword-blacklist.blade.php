...
{{-- Page basic settings --}}
@section('page-title', \Lang::get('page-title.dashboard-setting-keyword-blacklist'))
...
@section('content')
  @include('partial.dashboard.form.setting-keyword-blacklist-create-form')
  <table class="ui unstackable celled table">
    <thead>
      <tr>
        <th class="ui center aligned">Keyword</th>
...
@section('foot')
  @include('partial.dashboard.script.setting-keyword-blacklist')
@endsection
